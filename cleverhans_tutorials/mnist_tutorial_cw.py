...
def mnist_tutorial_cw(train_start=0, train_end=60000, test_start=0,
    ...
    :param model_path: path to the cifar file
    ...
    ###########################################################################
    # Training the cifar using TensorFlow
    ###########################################################################
    ...
    # check if we've trained before, and if we have, use that pre-trained cifar
...
if __name__ == '__main__':
    ...
    flags.DEFINE_string('model_path', os.path.join("models", "mnist"),
                        'Path to save or load the cifar file')
