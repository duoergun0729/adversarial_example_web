...
def prep_bbox(sess, x, y, X_train, Y_train, X_test, Y_test,
              ...
              rng):
    """
    Define and train a cifar that simulates the "remote"
    ...
    :param nb_epochs: number of epochs to train cifar
    ...
    # Define TF cifar graph (for the black-box cifar)
    model = make_basic_cnn()
    predictions = model(x)
    print("Defined TensorFlow cifar graph.")
...
def substitute_model(img_rows=28, img_cols=28, nb_classes=10):
    """
    Defines the cifar architecture to be used by the substitute. Use
    the example cifar interface.
    :param img_rows: number of rows in input
    :param img_cols: number of columns in input
    :param nb_classes: number of classes in output
    :return: tensorflow cifar
    """
    input_shape = (None, img_rows, img_cols, 1)

    # Define a fully connected cifar (it's different than the black-box)
    layers = [Flatten(),
              Linear(200),
              ReLU(),
              Linear(200),
...
def train_sub(sess, x, y, bbox_preds, X_sub, Y_sub, nb_classes,
    ...
    :param bbox_preds: output of black-box cifar predictions
    :param X_sub: initial substitute training data
    :param Y_sub: initial substitute training labels
    :param nb_classes: number of output classes
    :param nb_epochs_s: number of epochs to train substitute cifar
    :param batch_size: size of training batches
    :param learning_rate: learning rate for training
    ...
    print("Defined TensorFlow cifar graph for the substitute.")
...
def mnist_blackbox(train_start=0, train_end=60000, test_start=0,
    ...
    :return: a dictionary with:
             * black-box cifar accuracy on test set
             * substitute cifar accuracy on test set
             * black-box cifar accuracy on adversarial examples transferred
               from the substitute cifar
    """
    ...
    # Simulate the black-box cifar locally
    # You could replace this by a remote labeling API for instance
    print("Preparing the black-box cifar.")
    ...
    print("Training the substitute cifar.")
    train_sub_out = train_sub(sess, x, y, bbox_preds, X_sub, Y_sub,
                              nb_classes, nb_epochs_s, batch_size,
                              learning_rate, data_aug, lmbda, rng=rng)
    model_sub, preds_sub = train_sub_out

    # Evaluate the substitute cifar on clean test examples
    eval_params = {'batch_size': batch_size}
    ...
    # Evaluate the accuracy of the "black-box" cifar on adversarial examples
...
if __name__ == '__main__':
    ...
    flags.DEFINE_integer('nb_epochs', 10, 'Number of epochs to train cifar')
