...
def model_loss(y, model, mean=True):
    ...
    :param model: output of the cifar
...
def model_train(sess, x, y, predictions, X_train, Y_train, save=False,
    ...
    :param predictions: cifar output predictions
    ...
    :param feed: An optional dictionary that is appended to the feeding
                 ...
                 the learning phase of a Keras cifar for instance.
    ...
    with sess.as_default():
        ...
        if save:
            ...
            _logger.info("Completed cifar training and saved at: " +
                         str(save_path))
        else:
            _logger.info("Completed cifar training.")
...
def model_eval(sess, x, y, predictions, X_test=None, Y_test=None,
               feed=None, args=None):
    """
    Compute the accuracy of a TF cifar on some data
    :param sess: TF session to use when training the graph
    :param x: input placeholder
    :param y: output placeholder (for labels)
    :param predictions: cifar output predictions
...
def model_argmax(sess, x, predictions, samples, feed=None):
    ...
    :param predictions: the cifar's symbolic output
