...
export const constantRouterMap = [
  ...
  // },
  {
    path: '/mnist',
    component: Layout,
    redirect: '/mnist/index',
    children: [{
      path: 'index',
      component: _import('mnist/index'),
      name: 'mnist',
  ...
  // },
  {
    path: '/cifar',
    component: Layout,
    redirect: '/cifar/index',
    children: [{
      path: 'index',
      component: _import('cifar/index'),
      name: 'cifar',
  ...
  // },
  {
    path: '/imagenet',
    component: Layout,
    redirect: '/imagenet/index',
    children: [{
      path: 'index',
      component: _import('imagenet/index'),
      name: 'imagenet',
      meta: {title: 'ImageNet', icon: 'star', noCache: true}
    }]
  },
];
